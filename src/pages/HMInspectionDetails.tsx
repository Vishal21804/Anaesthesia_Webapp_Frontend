...
import { getInspectionDetails } from '../services/machine';
...
export function HMInspectionDetails() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                console.log("Inspection ID:", parsedId);

                if (!parsedId || isNaN(parsedId)) {
                    console.error("Invalid inspection ID:", inspectionId);
                    setError("Invalid Inspection ID provided.");
                    setLoading(false);
                    return;
                }

                const res = await getInspectionDetails(parsedId, user.id);
                if (res.status) {
                    setData(res.data);
                } else {
            ...
            <div className="w-full px-6 pt-10">
                ...
                >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-[#F8FAFC] dark:bg-slate-800/40 rounded-[20px] p-4 flex items-center gap-4 border-slate-200 dark:border-slate-700/50">
                                ...
                                return (
                                    <div key={index} className="relative">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            {item.remarks && (
                                                <div className="bg-[#F8FAFC] dark:bg-slate-800/40 rounded-[18px] px-6 py-4 mt-2 border-slate-200 dark:border-slate-700/50">
