...
export function HMDashboard() {
  ...
  useEffect(() => {
    ...
    if (userString) {
      ...
      const fetchDashboardData = async () => {
        try {
          setLoading(true);
          const data = await getHMDashboard(userData.id);
          setStats([
            { label: 'Total OTs', value: data.total_ots.toString(), icon: LayoutGrid, color: 'purple' },
            { label: 'Total Machines', value: data.total_machines.toString(), icon: Wrench, color: 'blue' },
            { label: 'Technicians', value: data.technicians.toString(), icon: Users, color: 'blue' },
            { label: 'Machines With Issues', value: data.machines_with_issues.toString(), icon: AlertCircle, color: 'rose' }
          ]);
        } catch (err) {
  ...
  const navigationCards = [
    { id: 'management', title: 'Management', description: 'OT Administration', icon: Settings, color: 'slate', path: '/management/management-page' },
    ...
    { id: 'machines', title: 'Machines', description: 'Inventory & Maintenance', icon: Wrench, color: 'blue', path: '/management/management-page?tab=machines' },
