...
export const assignOT = async (data: { user_id: number, ot_id: number }, creatorId: number) => {
...
export const getAvailableOTs = async (creatorId: number, userRole: string) => {
...
export const getUserOTAssignments = async (userId: number, creatorId: number) => {
...
export const unassignOT = async (userId: number, otId: number, creatorId: number) => {
